    ...
    <>
      ...
      <div className="scrollbar2">
        ...
        <div className="m-auto max-w-max">
          {/* 메뉴 리스트 */}
          <div className="mt-4 x-lg border border-gray-200 bg-white shadow-sm">
            <ul role="list" className="divide-y divide-gray-100 max-h-96">
              {menuItems.map((menu) => (
                <li key={menu.menuId} className="flex justify-x px-12 py-10">
