...
const AddExtraUSERComponent = ({ shopId }) => {
  console.log(shopId);
            ...
            <div className="">
              <div className="mt-4 grid grid-cols-1 gap-y-8 sm:grid-cols-2 sm:gap-x-4">
                ...
                <div className="sm:col-span-2">
                  <p> {defaultShop.shopOwnerDTO.title} &gt; 제보 정보 추가</p>{' '}
                  <br />
                  <label
                    htmlFor="address"
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      placeholder={defaultShop.shopOwnerDTO.title}
                ...
                <div className="sm:col-span-2 mb-4">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      onChange={handleChangeShop}
                      type="text"
                      placeholder={defaultShop.shopOwnerDTO.location}
                      className="block w-full rounded-md bg-white px-3 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                    />
                  </div>
                </div>
...
export default AddExtraUSERComponent;
