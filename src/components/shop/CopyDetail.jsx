...
const DetailComponent = ({ shop, shopId }) => {
  ...
  return (
    ...
    >
      <main className="m-auto mt-4 lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16-4 py-4 sm:px-4 sm:pb-4 sm:pt-2 lg:max-w-full lg:px-32">
        <TabGroup className="lg:col-span-7">
          <div className="mx-auto sm:lg:lg lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16-8 sm:py-6 lg:max-w-full lg:px-8">
            <TabList className="-mb-px flex space-x-12">
              {/* First tab: 제보된 정보 */}
