...
// props 이름
const DetailComponent = ({ shop, shopId, infoType }) => {
  ...
  // Tab 변경시 infoType 분기
  const [infoTypeState, setInfoTypeState] = useState(''); // tab 선택시 기본 'USER"
  ...
  const handleClickAddMenu = () => {
    navigate({
      pathname: `/shop/addMenu/${shopId}/${infoType}`,
    });
  };

  // Tab 변경시 이벤트
  const handleTabChange = (type) => {
    setInfoTypeState(type);
  };

  // 경로에서 받아온 shopId, infoType으로 나누어서 경로 바꿔주기
  // useEffect(() => {
  //   if (infoTypeState === 'USER') {
  //     navigate(`/shop/detail/${shopId}/USER`);
  //   } else if (infoTypeState === 'OWNER') {
  //     navigate(`/shop/detail/${shopId}/OWNER`);
  //   }
  // }, [infoTypeState, navigate]);
    ...
    <div className="bg-white">
      <div className="mx-auto px-4 lg:max-w-7xl ">
        ...
        <div className="lg:grid lg:grid-cols-7 lg:grid-rows-1 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          {/* Tab Group for separating information */}
                          ...
                          <div className="flex flex-col-reverse">
                            <div className="mt-4">
                              ...
                              <p className="mt-2 text-sm text-gray-500">
                                최근 수정일 : {shop.shopUserDTO.updateDate} (
                                Updated
                                <time
                                  dateTime={shop.shopUserDTO.updateDate}
                                ></time>
                                )
                              </p>
                            </div>
                        ...
                        <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
                          <div className="flex flex-col-reverse">
                            <div className="mt-4">
                              ...
                              <p className="mt-2 text-sm text-gray-500">
                                최근 수정일 : {shop.shopOwnerDTO.updateDate} (
                                Updated
                                <time
                                  dateTime={shop.shopOwnerDTO.updateDate}
                                ></time>
                                )
                              </p>
                            </div>
